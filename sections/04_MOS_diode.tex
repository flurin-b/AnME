...
\begin{minipage}[t]{0.66\columnwidth}
    ...
    %CHECKED: [Simi] @ Flurin: WO kommt das her? Ist das relevant?   
    %TODO: [Flurin] @Simi: Hat er glaube ich nur aufgeschrieben oder so und ist für die moderate inversion oder so - also hochgradig irrelevant, kannst du gerne löschen.
    \[
