...
%CHECK [Simi] @Flurin: Habe ich das so richtig gezeichnet? (Basiert auf den Informationen von V9 S23)
%CHECK [Flurin] @Simi: Evtl. müsste beim kleinsignalersatzschaltbild die V_SB weggelassen werden, da ja sonst die C_SB und C_DB nicht als C_SD zusammengefasst werden können... Sollte aber nicht wirklich problematisch sein...
