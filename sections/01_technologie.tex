...
% [Simi] I used the image from the script instead of the one from the slides (V1 S14)
...
% [Flurin] @Simi its a bit tricky to get working, but if you want i can show you. 
% I can also stop using svgs - might be smart because whoever will want to edit the FoSa will have the same problem. 
% I like svgs though... :(
...
% CHECKED: [Simi] @Flurin "sind diese Kondensatoren bedeutend kleiner" -> flächenmässig oder bezüglich ihrer Kapazität? 
...
%CHECK: Bilder zu den Parasitäten V1 S27
% [Simi] @Flurin: welche genau? Das mit dem Halbleiteraufbau UND das mit dem Schema?
% [Flurin] @Simi: Veilleicht ist ein kurzer Beschrieb ausreichend - habe den etwas verwirrenden bestehenden Inhalt etwas angepasst.
