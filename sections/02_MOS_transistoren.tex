...
\begin{minipage}[t]{0.48\columnwidth}
    % TODO: Pfeil bei g_mb umkehren damit es mit Formel stimmt
...
\begin{enumerate}
    \item Grosssignalanalyse um AP zu bestimmen.
    \item Parameter nach Formel bestimmen:
\end{enumerate}
\[
...
Ungesättigt:
\[
    g_0 = \mu C_{ox} \frac{W}{L} ((V_{GS} - V_T) - V_{DS})
\]
Gesättigt:
\[
    g_0 = \lambda I_{DS, sat} = \frac{I_D}{V_E + V_{DS}} \approx \frac{I_D}{a_E L + V_{DS}}
\]
...
Gesättigt:
\[
    g_0 = \lambda I_{DS, sat} = \frac{I_D}{V_E + V_{DS}}
\]

\subsection{Zusammenhänge}
%TODO: This seems important but I don't know how to integrate this in a logical way
...
\subsection{Verstärker dimensionieren}
\begin{itemize}
    \item Arbeitspunkt bestimmen.
    \item $I_D$ wählen, sodass der Transistor ungesättigt ist.
